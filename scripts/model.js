...
/**
 * Fornecedor Backbone Model
 */
model.FornecedorModel = Backbone.Model.extend({
	urlRoot: 'api/fornecedor',
	idAttribute: 'idFornecedor',
	idFornecedor: '',
	nomeFantasia: '',
	razaoSocial: '',
	cnpj: '',
...
/**
 * Fornecedor Backbone Collection
 */
model.FornecedorCollection = model.AbstractCollection.extend({
	url: 'api/fornecedores',
	model: model.FornecedorModel
});
