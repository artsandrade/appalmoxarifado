...
<script src="styles\style.css"></script>
	<div class="container">
		...
		<div class="hero-unit">
			...
			<p>Este site foi feito por um tabalho de faculdade da máteria TÓPICOS ESPECIAIS EM ENGENHARIA DE SOFTWARE </p>
			...
			<a class="btn btn-primary btn-large" data-toggle="modal" href="./usuarios">Usuarios &raquo;</a></p>
