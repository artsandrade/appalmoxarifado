<?php
/** @package    appalmoxarifado::Controller */
...
class UsuarioController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('IdUsuario,Nome,NMatricula,Email,Login,Senha,NivelAcesso'
				, '%'.$filter.'%')
			);
	...
	public function Update()
	{
		try
		{
			...
			$usuario->NMatricula = $this->SafeGetVal($json, 'nMatricula', $usuario->NMatricula);
			...
			$usuario->NivelAcesso = $this->SafeGetVal($json, 'nivelAcesso', $usuario->NivelAcesso);
