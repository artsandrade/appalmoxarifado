...
require_once("DAO/FornecedorCriteriaDAO.php");

/**
 * The FornecedorCriteria class extends FornecedorDAOCriteria and is used
 ...
 * @version 1.0
 */
class FornecedorCriteria extends FornecedorCriteriaDAO
{
